...
const ViewApplications = () => {
    ...
    useEffect(() => {
        ...
        if (sortBySkills) {
            filtered.sort((a, b) => (b.matchedSkills || 0) - (a.matchedSkills || 0));
        }
        ...
        {loading ? (
          ...
          filteredJobs.map((job) => (
            <div
              ...
              className={`cursor-pointer p-3 border-b rounded hover:bg-gray-100 transition ${
                selectedJobId === job._id ? 'bg-blue-100' : ''
              }`}
            >
        ...
        {selectedJobId && (
          <div className="flex flex-wrap gap-3 mb-4 bg-white p-3 rounded-xl shadow-sm">
            ...
            <button
              ...
              className={`min-w-[150px] border border-gray-300 px-4 py-2 rounded-full text-sm shadow-sm transition-all ${
                sortBySkills
              ...
              >
                ...
                {openAppId === app._id && (
                  <div className="mt-3 text-sm text-gray-700 space-y-1">
                    ...
                    <p>
                      Skills Matched: <strong>{app.matchedSkills || 0}</strong>
                    </p>
                    <a
