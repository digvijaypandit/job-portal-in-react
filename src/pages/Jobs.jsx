  ...
  return (
    <div className="bg-white text-gray-900 min-h-screen">
      ...
      <div className="flex flex-col-reverse lg:flex-row items-center justify-between gap-12 px-6 py-16 ml-8 mt-10">
        <motion.div
          className="w-full max-w-[800px] lg:w-[55%]"
          initial={{ opacity: 0, y: -40 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.8 }}
        >
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-4 text-gray-800">
            <Typewriter words={['Discover Your Dream Job']} typeSpeed={30} />
          </h1>
      ...
      <div className="max-w-6xl mx-auto px-6 py-10 relative">
        ...
        <div className="relative">
          <button
            onClick={() => scroll("left")}
            className="absolute -left-10 top-[45%] hover:bg-gray-300 transform -translate-y-1/2 p-3 bg-white shadow-lg rounded-full"
          >
          ...
          <div
            ref={scrollRef}
            className="flex overflow-x-auto space-x-6 pb-4 scroll-smooth snap-x snap-mandatory no-scrollbar"
          >
            {filteredJobs.map((job) => (
              ...
              >
                ...
                <button
                  ...
                  className="mt-4 px-4 py-2 bg-white text-blue-700 rounded-lg hover:bg-gray-200 transition"
                >
                  Apply Now
                </button>
              </div>
          ...
          <button
            ...
            className="absolute -right-10 top-[45%] hover:bg-gray-300 transform -translate-y-1/2 p-3 bg-white shadow-lg rounded-full"
          >
